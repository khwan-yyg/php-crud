...
<body class="bg-body-tertiary">
                ...
                <form action="<?php echo $base_url; ?>/product-form.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="detail" class="form-control" rows="3" id=""><?php echo $result['detail'] ?></textarea>
                        </div>
                            ...
                            <?php while ($product = mysqli_fetch_assoc($query)) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Delete this from Cart ?');" role="button" href=" <?php echo $base_url; ?>/product-delete.php?id=<?php echo $product['id']; ?> " class="btn btn-outline-danger"> <i class="fa-solid fa-trash me-1"></i> Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
    ...
    <script href="<?php echo "$base_url" ?>/assets/js/bootstrap.min.js" rel="stylesheet"></script>
</body>
