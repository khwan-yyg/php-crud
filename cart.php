...
$productIds = [];
foreach (($_SESSION['cart'] ?? []) as $cardId => $cartQty) {
    $productIds[] = $cardId;
}
                            ...
                            <?php if ($rows > 0): ?>
                                <?php while ($product = mysqli_fetch_assoc($query)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="return confirm('Delete this from Cart ?');" role="button" href=" <?php echo $base_url; ?>/cart-delete.php?id=<?php echo $product['id']; ?> " class="btn btn-outline-danger"> <i class="fa-solid fa-trash me-1"></i> Delete</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                                <tr>
